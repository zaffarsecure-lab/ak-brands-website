...
## Overview
This guide provides step-by-step instructions to add a "Products" menu item and a comprehensive Products section to the AK Brands Marketing website.

---

## STEP 1: Add "Products" to Menu (Line ~1528)

**Location:** Find the menu dropdown section around line 1528
...
## STEP 2: Add Products Section CSS (Before `</style>` tag around line 1513)

**Location:** Add this CSS before the closing `</style>` tag (around line 1513)
...
## STEP 3: Add Products Section HTML (After hero section, before features section around line 1600)

**Location:** Insert this HTML section right after the `</section>` closing tag of the hero section (around line 1600), BEFORE the features section
...
1. **Edit index.html** on the `add-products-section` branch
2. **Add Products to menu** (Step 1)
3. **Add CSS styles** (Step 2)
4. **Add HTML section** (Step 3)
5. **Commit changes**
...
👉 **https://github.com/zaffarsecure-lab/ak-brands-website/edit/add-products-section/index.html**
...
- ✅ Comprehensive Products section with 15 product categories
- ✅ Professional card-based layout with hover effects
- ✅ Intro and footer text explaining product sourcing
- ✅ Responsive design matching existing sections

---

**Need Help?** Follow the line numbers and code blocks exactly as shown above.
